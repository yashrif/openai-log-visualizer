...
export const CATEGORY_COLORS: Record<EventCategory, string> = {
  session: "bg-violet-500/20 text-violet-300 border-violet-500/30",
  error: "bg-red-500/20 text-red-300 border-red-500/30",
  conversation: "bg-blue-500/20 text-blue-300 border-blue-500/30",
  audio_buffer: "bg-amber-500/20 text-amber-300 border-amber-500/30",
  response_lifecycle: "bg-emerald-500/20 text-emerald-300 border-emerald-500/30",
  response_output: "bg-teal-500/20 text-teal-300 border-teal-500/30",
  response_content: "bg-cyan-500/20 text-cyan-300 border-cyan-500/30",
  response_audio: "bg-pink-500/20 text-pink-300 border-pink-500/30",
  response_text: "bg-indigo-500/20 text-indigo-300 border-indigo-500/30",
  function_call: "bg-orange-500/20 text-orange-300 border-orange-500/30",
  rate_limits: "bg-slate-500/20 text-slate-300 border-slate-500/30",
